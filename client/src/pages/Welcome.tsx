    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="max-w-md w-full">
        ...
        <div className="space-y-4 flex flex-col justify-center items-center">
          <button className='lg:w-[30rem] w-[19rem] py-4 bg-primary rounded-lg flex justify-center items-center hover:bg-primary-container hover:shadow-[0_0_15px_var(--color-primary)] transition-all'
          ...
          <button className='lg:w-[30rem] w-[20rem] py-4 bg-surface-container-high rounded-lg flex justify-center items-center hover:bg-surface-container-highest transition-all'
          onClick={()=>navigatTo("/foryou")}>
          
           <span className='text-xl text-white font-medium tracking-wider'>Continue as Guest</span>
          </button>
